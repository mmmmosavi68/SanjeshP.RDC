...
fnStateSaveParams:null,iStateDuration:7200,iDeferLoading:null,iDisplayLength:10,iDisplayStart:0,iTabIndex:0,oClasses:{},oLanguage:{oAria:{sSortAscending:": activate to sort column ascending",sSortDescending:": برای مرتب کردن ستون به صورت نزولی فعال کنید"},oPaginate:{sFirst:"First",sLast:"Last",sNext:"بعدی",sPrevious:"قبلی"},sEmptyTable:"هیچ داده ای در جدول موجود نیست",sInfo:"نمایش _START_ تا _END_ از _TOTAL_ ردیف",sInfoEmpty:"نمایش 0 تا 0 از 0 ردیف",sInfoFiltered:"(فیلتر شده از _MAX_ کل ردیف‌ها)",
    sInfoPostFix: "", sDecimal: "", sThousands: ",", sLengthMenu: "نمایش _MENU_ ردیف", sLoadingRecords: "در حال بارگذاری...", sProcessing:"پردازش...",sSearch:"جستوجو:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"ردیفی یافت نشد."},oSearch:l.extend({},u.models.oSearch),sAjaxDataProp:"data",sAjaxSource:null,sDom:"lfrtip",searchDelay:null,sPaginationType:"simple_numbers",sScrollX:"",sScrollXInner:"",sScrollY:"",sServerMethod:"GET",renderer:null,rowId:"DT_RowId"};E(u.defaults);u.defaults.column={aDataSort:null,
