...
{
    public class MenuRepository : EFRepository<Menu>, IMenuRepository, IScopedDependency
    {
        public MenuRepository(ApplicationDbContext dbContext) : base(dbContext)
        {
        }

        public async Task<List<Menu>> GetAllMenu(CancellationToken cancellationToken)
        {
